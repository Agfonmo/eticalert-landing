      ...
      <div class="article-content" style="margin:0 auto;">
        ...
        <table style="width:100%;border-collapse:collapse;margin:1.5rem 0;font-size:0.875rem;">
          ...
          <tbody>
            ...
            <tr style="background:var(--bg-tertiary);"><td style="padding:0.75rem;border:1px solid var(--border);">Roles <a href="/blog/rsii-guia-formulario-aipi" style="color:var(--accent);">RSII</a> granulares</td><td style="padding:0.75rem;border:1px solid var(--border);text-align:center;">✓</td><td style="padding:0.75rem;border:1px solid var(--border);text-align:center;">Verificar</td></tr>
