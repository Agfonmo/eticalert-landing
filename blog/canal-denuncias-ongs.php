  ...
  <div class="legal-page" style="padding-top:100px;">
    <div class="container">
      ...
      <div class="article-content" style="margin:0 auto;">
        ...
        <div style="border-left:3px solid var(--accent);background:var(--bg-tertiary);padding:1.25rem 1.5rem;border-radius:0 8px 8px 0;margin:2rem 0;">
          <strong style="color:var(--accent);">Dato clave:</strong> Una ONG o fundación puede tener el canal operativo y conforme a la Ley 2/2023 en 5 minutos con EticAlert. El plan Company (39 €/mes) cubre hasta 150 empleados e incluye gestión de comunicaciones, plazos automáticos y responsable externo del canal. Gratis hasta 20 empleados.
        </div>
