...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"¿Una empresa privada que recibe una subvención está obligada a tener canal de denuncias?","acceptedAnswer":{"@type":"Answer","text":"No necesariamente. Recibir una subvención puntual (CDTI, ICO, FEDER por proyecto, ayuda autonómica) no obliga por sí solo a implantar un canal de denuncias según la Ley 2/2023. La obligación nace de tener 50 o más empleados, pertenecer a un sector regulado, o estar bajo el control efectivo de una administración pública. Una subvención es financiación, no control. Lo que sí puede ocurrir es que el clausulado de la convocatoria exija medidas antifraude como condición del beneficiario."}},{"@type":"Question","name":"¿Las entidades que reciben subvenciones están obligadas a canal de denuncias?","acceptedAnswer":{"@type":"Answer","text":"La obligación directa aplica a partidos políticos, sindicatos, organizaciones empresariales y sus fundaciones vinculadas que reciban o gestionen fondos públicos, independientemente de su tamaño. Para otras entidades subvencionadas, la obligación depende de si están bajo el control efectivo de una administración pública o si gestionan fondos europeos como organismo intermedio. Una pyme que recibe una ayuda puntual no queda obligada solo por ese motivo."}},{"@type":"Question","name":"¿Un partido político pequeño necesita canal de denuncias?","acceptedAnswer":{"@type":"Answer","text":"Si recibe financiación pública (subvenciones electorales o de funcionamiento ordinario), sí. La Ley 2/2023 los incluye expresamente en el art. 10.2.d) sin ningún umbral de tamaño o de financiación mínima."}}]}
</script>
  ...
  <div class="legal-page" style="padding-top:100px;">
    <div class="container">
      ...
      <div class="article-content" style="margin:0 auto;">
        ...
        <div style="background:rgba(59,130,246,.07);border:1.5px solid rgba(59,130,246,.25);border-radius:var(--radius-lg);padding:1.5rem 1.75rem;margin:2rem 0;">
          <p style="font-weight:700;margin:0 0 .5rem;font-size:1rem;">⚠️ ¿Tu empresa solo recibe una subvención puntual?</p>
          <p style="margin:0 0 .75rem;color:var(--text-secondary);">Si tu empresa es una <strong>pyme o sociedad privada ordinaria</strong> que ha recibido una ayuda del CDTI, un préstamo ICO, una subvención de tu comunidad autónoma o fondos FEDER para un proyecto concreto, <strong>la subvención por sí sola no te obliga</strong> a implantar un canal de denuncias según la Ley 2/2023.</p>
          <p style="margin:0 0 .75rem;color:var(--text-secondary);">La obligación legal nace de:</p>
          <ul style="margin:.25rem 0 .75rem 1.25rem;color:var(--text-secondary);display:flex;flex-direction:column;gap:.25rem;">
            <li>Tener <strong>50 o más empleados</strong> (criterio general), o</li>
            <li>Pertenecer a un <strong>sector regulado</strong> (financiero, PBC, transporte, medio ambiente…), o</li>
            <li>Estar bajo el <strong>control efectivo</strong> de una administración pública — mayoría en el órgano de gobierno, no solo financiación puntual.</li>
          </ul>
          <p style="margin:0;color:var(--text-secondary);">Una subvención es dinero, no control. Recibirla no convierte a tu empresa en una entidad pública ni te somete al régimen de este artículo. <strong>Lo que sí puede ocurrir</strong> es que el pliego o la resolución de concesión de esa ayuda incluya entre sus condiciones disponer de medidas antifraude — revisa el clausulado específico de cada convocatoria.</p>
        </div>
