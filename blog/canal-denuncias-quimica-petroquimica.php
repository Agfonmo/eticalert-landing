    ...
    <div class="container">
      ...
      <div class="article-content" style="margin:0 auto;">
        ...
        <div style="background:var(--bg-card);border:1px solid var(--border-accent);border-radius:var(--radius-lg);padding:1.75rem;margin:2.5rem 0;">
          ...
          <p style="color:var(--text-secondary);margin-bottom:1.5rem;">Starter para plantas con 3 usuarios en la organización gestora, Business y Company para instalaciones más grandes. Cifrado, anonimato, plazos automáticos y exclusión preventiva de gestores implicados.</p>
