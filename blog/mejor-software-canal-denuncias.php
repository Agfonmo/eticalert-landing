  ...
  <div class="legal-page" style="padding-top:100px;">
    <div class="container">
      ...
      <div class="article-content" style="margin:0 auto;">
        ...
        <p>Plataforma SaaS española diseñada específicamente para pymes obligadas por la Ley 2/2023. Activación 100% self-serve en minutos, precio público desde 19€/mes, datos en la UE. Lo que diferencia técnicamente a EticAlert del resto del mercado: cifrado AES-256-GCM aplicado en base de datos (no solo en tránsito), anonimato real con identidad del informante fuera de logs, y el informante puede excluir gestores concretos por conflicto de interés desde el propio formulario público. Los expedientes cerrados generan un hash SHA-256 verificable públicamente en <code>/verificar</code>, lo que permite acreditar integridad documental ante la <a href="/blog/aipi-sanciones-canal-denuncias" style="color:var(--accent);">AIPI</a> o un juzgado. El canal no se puede publicar si faltan requisitos legales — bloqueo real, no solo advertencia. Historial auditado de nombramientos <a href="/blog/rsii-guia-formulario-aipi" style="color:var(--accent);">RSII</a>, alertas proactivas de plazos (7 días / 3 meses) y ticketing de soporte integrado en la plataforma. Plan Starter desde 9€/mes hasta 20 empleados.</p>
