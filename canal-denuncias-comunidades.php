  ...
  <section style="padding:120px 0 50px;">
    <div class="container" style="max-width:900px;">
      ...
      <p class="fade-up" style="font-size:0.875rem;color:var(--text-muted);">
        ¿Buscas información específica de <a href="/canal-denuncias-madrid" style="color:var(--accent);">Madrid</a> o <a href="/canal-denuncias-barcelona" style="color:var(--accent);">Barcelona</a>? Tienen guía propia.
      </p>
