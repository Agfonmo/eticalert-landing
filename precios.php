<?php
$page_title       = 'Precios | Canal de Denuncias desde 9€/mes · EticAlert';
$page_description = 'Planes de canal de denuncias desde 9€/mes, sin permanencia. Activo en 5 minutos y conforme a la Ley 2/2023 desde el primer día.';
...
<!-- El schema SoftwareApplication con precios ya se emite globalmente desde includes/header.php -->
      ...
      <div class="pricing-grid">
        ...
        <div class="pricing-card featured fade-up delay-2">
          ...
          <ul class="pricing-features">
            ...
            <li class="pricing-feature"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg><span>5 usuarios</span></li>
      ...
      <div style="overflow-x:auto;" class="fade-up">
        <table class="comparison" style="min-width:700px;">
          ...
          <tbody>
            ...
            <tr><td>Usuarios</td><td class="check">3</td><td class="check">4</td><td class="check">5</td><td class="check">Ilimitados</td></tr>
